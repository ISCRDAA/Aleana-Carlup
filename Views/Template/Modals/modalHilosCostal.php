<!-- Modal -->
<div class="modal fade" id="modalFormHilosCostal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formHilosCostal" name="formHilosCostal" class="form-horizontal">
                    <input type="hidden" id="idHilosCostal" name="idHilosCostal" value="">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control selectpicker" id="txtMarca" name="txtMarca" required="">
                                <option value="Aguila">Coperativa</option>
                            </select>
                        </div>
                    </div>
...
<!-- Modal View-->
<div class="modal fade" id="modalViewHilosCostal" tabindex="-1" role="dialog" aria-hidden="true">
