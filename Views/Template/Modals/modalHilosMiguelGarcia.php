<!-- Modal -->
<div class="modal fade" id="modalFormHilosMiguelGarcia" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formHilosMiguelGarcia" name="formHilosMiguelGarcia" class="form-horizontal">
                    <input type="hidden" id="idHilosMiguelGarcia" name="idHilosMiguelGarcia" value="">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control selectpicker" id="txtMarca" name="txtMarca" required="">
                                <option value="Miguel García">Miguel García</option>
                            </select>
                        </div>
                    </div>
...
<!-- Modal View-->
<div class="modal fade" id="modalViewHilosMiguelGarcia" tabindex="-1" role="dialog" aria-hidden="true">
