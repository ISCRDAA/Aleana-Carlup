<!-- Modal -->
<div class="modal fade" id="modalFormHilosInternacionales" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formHilosInternacionales" name="formHilosInternacionales" class="form-horizontal">
                    <input type="hidden" id="idHilosInternacionales" name="idHilosInternacionales" value="">
